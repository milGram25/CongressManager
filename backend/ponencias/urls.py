...
from .views import (
    ...
    RubricaExtensoView, PreguntasResumenView, ResumenDetalleView,
...
urlpatterns = [
    ...
    path('resumenes/<int:pk>/detalle/', ResumenDetalleView.as_view(), name='resumen-detalle'),
    ...
    path('ponencia/<int:pk>/enlace/', ActualizarEnlacePonenciaView.as_view(), name='actualizar-enlace'),
]
