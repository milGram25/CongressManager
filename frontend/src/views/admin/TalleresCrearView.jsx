    ...
    return (
        <div className="w-full space-y-8 pb-10">
            ...
            <div className="flex justify-end gap-4">
                <button
                    onClick={() => navigate(-1)}
                    className="px-8 py-3 rounded-xl border border-base-300 text-base-content/60 font-bold hover:bg-base-200 transition-all active:scale-95 text-xs"
                >
                    Cancelar
                </button>
                <button
                    onClick={() => tallerRef.current?.handleSave()}
                    className="px-10 py-3 rounded-xl bg-primary text-primary-content font-bold shadow-lg shadow-primary/20 hover:brightness-110 transition-all active:scale-95 text-xs"
                >
                    Guardar Taller
                </button>
            </div>
