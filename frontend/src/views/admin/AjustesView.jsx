...
import { MdAccountBalance, MdWork } from "react-icons/md";
    ...
    <div className="bg-base-100 p-8 rounded-3xl border border-base-300 shadow-sm min-h-[400px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto py-10">
        ...
        >
          ...
          <div>
            <h3 className="text-xl font-bold">Instituciones</h3>
            <p className="text-sm text-base-content/50 mt-2">Gestión de universidades y organizaciones afiliadas</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            <h3 className="text-xl font-bold">Áreas</h3>
            <p className="text-sm text-base-content/50 mt-2">Administración de áreas temáticas y departamentos</p>
          </div>
        </button>
      </div>
    </div>
