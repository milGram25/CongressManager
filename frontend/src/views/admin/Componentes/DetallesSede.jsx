        ...
        <div className="w-full mb-10 animate-in slide-in-from-top duration-500">
            ...
            <div className="w-full grid bg-white border border-gray-100 rounded-b-[32px] shadow-sm p-8">
                <div className="border-b border-gray-100 pb-6 mb-6">
                    <p className="text-xs font-black text-gray-400 mb-4">Información del edificio</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-6">
                        <p className="text-xs font-black text-gray-400">Ubicación geográfica</p>
                    ...
                    <div className="space-y-6">
                        <p className="text-xs font-black text-gray-400">Dirección y referencia</p>
