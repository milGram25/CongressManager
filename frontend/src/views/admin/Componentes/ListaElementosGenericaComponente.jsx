...
export default function ListaElementosGenerica({titulo, elementoBuscar, descripcion, listaIconos, listaElementos}){
    ...
    return(
        <div className="w-120 h-min-50 border border-b rounded-lg">
            {/*header*/}
            <div className="flex bg-black h-15 items-center rounded-t-lg">
                <div className="flex flex-1 bg-white m-2 border border-b h-10 rounded-full pl-5">
                    <input className="w-full" type="text" placeholder={`Buscar ${elementoBuscar}`}/>
            ...
            <div className="flex h-20 flex m-4 border-b border-b">
                <div className="w-80">
                    <h1>Título genérico{titulo}</h1>
                    <div className="ml-4 text-gray-500">
                        Descripción genérica {descripcion}
                    </div>
