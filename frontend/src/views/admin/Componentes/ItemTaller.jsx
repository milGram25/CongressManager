...
const ItemTaller = ({ listaDatos, onViewItem }) => {
    ...
    const Row = ({ icon: Icon, label, value }) => (
        <div className="flex items-center justify-between gap-6 mb-3">
            <div className="flex items-center gap-3 text-base-content/60 min-w-[120px] flex-1">
    ...
    return (
        <TarjetaGenerica
            titulo={listaDatos.nombre_evento ? listaDatos.nombre_evento : "Sin título"}
        ...
        >
            <Row icon={FiMapPin} label="Congreso" value={listaDatos.nombre_congreso} />
            <Row icon={FiUser} label="Tallerista" value={listaDatos.tallerista} />
