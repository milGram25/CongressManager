...
// Opciones de filtro para la lista de extensos
...
// Funcion para exportar extensos a CSV
...
// Punto de estado con color segun si esta activo o no
    ...
    <section className="overflow-hidden rounded-[26px] border border-black/55 bg-white shadow-sm">
      <div className="flex items-center gap-3 bg-[#000000] px-3 py-2.5">
        <label className="relative flex-1">
          ...
          <input
            className="h-11 w-full rounded-full border border-slate-300 bg-white pl-11 pr-12 text-sm font-medium text-slate-700 outline-none transition-colors placeholder:text-slate-500 focus:border-[#000000] focus:ring-1 focus:ring-[#000000]/30"
            type="text"
            placeholder="Buscar extenso"
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div ref={filterRef} className="relative">
              ...
              >
                <MdFilterAlt size={18} className="text-[#000000]" />
