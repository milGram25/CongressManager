...
export default function DictaminadorLayout() {
  ...
  const closeDrawer = () => {
    const drawerCheckbox = document.getElementById("dictaminador-drawer");
    if (drawerCheckbox) {
      ...
      <div className="drawer-side z-50">
        ...
        <div className="bg-base-100 text-base-content min-h-full w-64 p-6 border-r border-gray-200 lg:border-none lg:bg-transparent flex flex-col">
          ...
          <nav className="flex flex-col space-y-1 mt-4 lg:mt-0">
            ...
            <NavLink to="/asistente/agenda" className={navLinkClass} onClick={closeDrawer}>
            ...
            <NavLink to="/dictaminador/dictamenes" className={navLinkClass} onClick={closeDrawer}>
              <div className="flex items-center gap-3">
                <MdGavel className="text-lg" />
                <span>Mis Dictámenes</span>
              </div>
            </NavLink>
            <NavLink to="/dictaminador/historial" className={navLinkClass} onClick={closeDrawer}>
              <div className="flex items-center gap-3">
