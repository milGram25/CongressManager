...
export default function PagosView() {
  ...
  const handleEmailSubmit = (e) => {
    e.preventDefault();
    setError('');
    // Regex para .edu o .edu.xx (mx, es, etc)
    const eduRegex = /\.edu(\.[a-z]{2,3})?$/i;
    if (!eduRegex.test(studentEmail)) {
      setError('El correo debe tener una extensión institucional válida (.edu, .edu.mx, etc).');
      return;
    }
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-4">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          type="email" 
                          required
                          placeholder="Tu correo .edu o .edu.mx"
