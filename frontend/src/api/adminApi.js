...
export async function uploadConstanciaApi(accessToken, idPersona, idCongreso, file, tipo, autoGenerated = false) {
  const formData = new FormData();
  if (file) formData.append('file', file);
  formData.append('id_congreso', idCongreso);
  formData.append('tipo', tipo);
  if (autoGenerated) formData.append('auto_generated', 'true');
